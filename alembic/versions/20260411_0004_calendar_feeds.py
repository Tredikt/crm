"""calendar feeds and imported ical events

Revision ID: 0004_calendar_feeds
Revises: 0003_google_calendar
...
revision: str = "0004_calendar_feeds"
down_revision: Union[str, None] = "0003_google_calendar"
...
def downgrade() -> None:
    op.drop_index(op.f("ix_imported_calendar_events_start_at"), table_name="imported_calendar_events")
