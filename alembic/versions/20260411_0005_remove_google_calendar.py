"""remove google calendar oauth tables and event id columns

Revision ID: 0005_remove_google_calendar
Revises: 0004_calendar_feeds
...
revision: str = "0005_remove_google_calendar"
down_revision: Union[str, None] = "0004_calendar_feeds"
