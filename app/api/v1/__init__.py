...
from app.api.v1 import auth, calendar_export, companies, deals, import_export, leads, projects, tags, tasks
...
protected.include_router(deals.router)
protected.include_router(companies.router)
protected.include_router(import_export.router)
